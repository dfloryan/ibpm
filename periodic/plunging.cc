...
int main(int argc, char* argv[]) {
    ...
    if(modelType == NONLINEAR) {
        ...
        vector<double> deriv1_vec;
        vector<double> deriv2_vec;
        ...
        for(int i = 0; i < numSteps; i++) {
            ...
            partial_vec.push_back(partial);
            deriv1_vec.push_back(deriv1);
            deriv2_vec.push_back(deriv2);
        }
        std::ofstream partialfile("partial.txt"), deriv1file("deriv1.txt"), deriv2file("deriv2.txt");
        std::ostream_iterator<double> partialit(partialfile, "\n"), deriv1it(deriv1file, "\n"), deriv2it(deriv2file, "\n");
        copy(partial_vec.begin(), partial_vec.end(), partialit);
        copy(deriv1_vec.begin(), deriv1_vec.end(), deriv1it);
        copy(deriv2_vec.begin(), deriv2_vec.end(), deriv2it);
    }
